  ...
  return (
    <div className="portfolio-root">
      ...
      <nav className="navbar">
        <div className="logo">
          <span className="logo-bracket">{"<"}</span>DK<span className="logo-bracket">{"/>"}</span>
        </div>
      ...
      {/* HERO */}
      <section id="about" data-section="About" className="hero-section" ref={heroRef}>
        ...
        <div className={`fade-up ${isLoaded ? "loaded" : ""}`} style={{ transitionDelay: "0.4s" }}>
          <p className="hero-desc">
            Frontend developer with <strong>3+ years</strong> crafting enterprise-grade interfaces.
        ...
        <div className={`fade-up stats-row ${isLoaded ? "loaded" : ""}`} style={{ transitionDelay: "0.6s" }}>
          {[
      ...
      {/* EXPERIENCE */}
      <section id="experience" data-section="Experience" className="content-section">
        ...
        <div className="card card-accent-top">
          <div className="exp-header">
            <div>
              ...
              <div className="exp-sub">formerly Acute Informatics Pvt. Ltd.</div>
            </div>
        ...
        <div className="card education-card">
          <div className="edu-left">
            ...
            <div className="edu-college">Navgujarat College of Computer Applications</div>
          </div>
      ...
      {/* PROJECTS */}
      <section id="projects" data-section="Projects" className="content-section">
        ...
        <div className="projects-grid">
          {PROJECTS.map((project, i) => (
            <div key={i} className="project-card card">
              ...
              <div className="project-tag" style={{ color: project.color }}>Featured Project</div>
              <h3 className="project-title">{project.title}</h3>
              <div className="project-subtitle">{project.subtitle}</div>
              <p className="project-desc">{project.description}</p>
              <div className="metrics-row">
                {project.metrics.map((m) => (
                  <span key={m} className="metric-badge" style={{
                    color: project.color,
          ...
          {[
            ...
            <div key={item.name} className="prof-row">
              ...
              <div className="prof-track">
                <div className="prof-fill" style={{ width: `${item.level}%` }} />
              </div>
            </div>
          ))}
        </div>
      ...
      {/* CONTACT */}
      <section id="contact" data-section="Contact" className="content-section contact-section">
        <div className="contact-card">
          <div className="contact-glow-top" />
          <div className="section-label" style={{ justifyContent: "center" }}>Let&apos;s Work Together</div>
          <h2 className="contact-title">Got a <span className="glow-text">project</span> in mind?</h2>
          ...
          <div className="social-links">
            {[
              ...
              <a key={link.label} href={link.url} target="_blank" rel="noreferrer" className="social-link">
                {link.label} ↗
              </a>
            ))}
          </div>
